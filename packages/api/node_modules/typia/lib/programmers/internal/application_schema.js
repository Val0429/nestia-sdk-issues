                    ...
                    try {
                        for (var _k = __values(meta.atomics), _l = _k.next(); !_l.done; _l = _k.next()) {
                            ...
                            if (a.type === "bigint")
                                ...
                                (0, application_number_1.application_number)(a)(attribute).forEach(function (s) { return insert(s); });
                            else if (a.type === "string")
                                (0, application_string_1.application_string)(meta)(a)(attribute).forEach(function (s) {
                                    return insert(s);
                                });
                        }
                    }
