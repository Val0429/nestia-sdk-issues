...
var check_string = function (project) {
    return function (atomic) {
        return function (input) {
            var conditions = check_string_type_tags(project)(atomic)(input);
            return {
...
var check_string_type_tags = function (project) {
    return function (atomic) {
        return function (input) {
            return atomic.tags.map(function (row) {
                return row.map(function (tag) { return ({
                    expected: "string & ".concat(tag.name),
