        ...
        return function (type) {
            return function (objects, explore) {
                ...
                var filtered = objects.filter(function (obj) {
                    ...
                    if (FIELDS.some(function (f) { return !statics.includes(f); }))
                        return report(null)("must have four properties - ".concat(FIELDS.map(function (str) { return "'".concat(str, "'"); }).join(", ")));
    ...
    var create_metadata_type_tag = function (report) {
        return function (obj) {
            ...
            var validate = (function () {
                var validate = find("validate").value;
...
var FIELDS = ["target", "kind", "value", "validate"];
